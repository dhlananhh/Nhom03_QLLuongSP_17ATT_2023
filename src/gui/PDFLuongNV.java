...
//        Paragraph hoTenNhanVien = new Paragraph("Họ tên nhân viên: " + luongNV.getNhanVien().getHoTenNV(), GLOBAL_FONT);
...
//        document.add(hoTenNhanVien);
    ...
    public static void addTblLuongRow (PdfPTable table, int stt, String deMuc, double soTien, Font globalFont) {
    	table.addCell(createCell(String.valueOf(stt), GLOBAL_FONT));
    	table.addCell(createCell(deMuc, GLOBAL_FONT));
    	table.addCell(createCell(String.valueOf(soTien), GLOBAL_FONT));
    }
    
    
    public static void addTblGiamTruRow (PdfPTable table, int stt, String deMuc, double bhxh, double bhyt, double bhtn, double thue, Font globalFont) {
    	table.addCell(createCell(String.valueOf(stt), GLOBAL_FONT));
    	table.addCell(createCell(deMuc, GLOBAL_FONT));
    	table.addCell(createCell(String.valueOf(bhxh), GLOBAL_FONT));
    	table.addCell(createCell(String.valueOf(bhyt), GLOBAL_FONT));
    	table.addCell(createCell(String.valueOf(bhtn), GLOBAL_FONT));
    	table.addCell(createCell(String.valueOf(thue), GLOBAL_FONT));
    }
    ...
    public static void InPhieuLuongNV (String maNV) {
        ...
        try {
            ...
            System.out.println("In phieu luong NV thanh cong: " + outputPdfPath);
        } catch (Exception e) {
            e.printStackTrace();
        }
